    ...
    if (err){
      ...
      console.log("Server response"+ JSON.stringify(rest));
		...
		var message = {
		    ...
		    html:"Bonjour " + rest[0].name + ", <br />\n" + 
                         "Tope vous remercie d'avoir assisté à la présentation <br />\n" +
                         "Nous remercions la société générale, BeMyApp et tous les autres participants pour ce super week-end <br />\n"+
                         "N'hésitez pas à visiter notre page Facebook : <br />\n" +
                         "Vous pouvez nous contacter par mail à : appli.tope@gmail.com",
		};
